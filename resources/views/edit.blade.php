...
<body>
    <div class="container mx-auto p-5">
        ...
        <div class="flex justify-between my-5">
            <h1 class="text-red-300 text-xl">Edit-{{$ourPost->name}}</h1>
        ...
        <div>
            <form action="{{ route('update', ['id' => $ourPost->id]) }}" method="POST" enctype="multipart/form-data">
                <div class="flex flex-col gap-5">
                    ...
                    @endif
                    <input type="text" name="name" required class="border p-2 w-full mb-2" placeholder="{{$ourPost->name}}">
                    <input type="text" name="description" required class="border p-2 w-full mb-2" placeholder="{{$ourPost->description}}">
